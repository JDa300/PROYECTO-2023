...
echo '<br><br><center><h1>Puede ver la información del proveedor, si desea puede descargar el informe en ecxel
    ...
    echo '<center><tr><th>ID</th><th>NOMBRE</th><th>TELEFONO</th><th>DIRECCION</th><th>ELIMINAR</th></tr></center>';
    while ($filas= mysqli_fetch_row($resultado))
     {
        echo '<tr><td>'.$filas[0].'</td><td>'.$filas[1].'</td><td>'.$filas[2].'</td><td>'.$filas[3].'</td> 
        <td><form action="eliminar4.php" method="post">
     ...
     echo ('<center><br><br><form action="generarxls4.php" method="post" class="login-form"><input type="submit" value="GENERAR_XLS" class="btn"> 
     </form></td></tr></center>');
