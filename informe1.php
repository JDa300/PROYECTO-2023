...
<section class="login" id="login">
    <div class="heading">
       <h3>Informe Empleado</h3>
    </div>

<?php


echo '<br><br><center><h1>Puede ver la información del empleado, si desea puede descargar el informe en ecxel
    ...
    echo '<center><tr><th>DOCUMENTO</th><th>PERFIL</th><th>NOMBRE</th><th>APELLIDO</th><th>CORREO</th><th>Eliminar Registro</th></tr></center>';
    while ($filas= mysqli_fetch_row($resultado))
     {
        echo '<tr><td>'.$filas[0].'</td><td>'.$filas[2].'</td><td>'.$filas[3].'</td><td>'.$filas[4].'</td><td>'.$filas[5].'</td>
        <td><form action="eliminar1.php" method="post">
     ...
     echo ('<center><br><br><form action="generarxls1.php" method="post" class="login-form"><input type="submit" value="GENERAR_XLS" class="btn"> 
     </form></td></tr></center>');
