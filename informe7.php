...
<section class="login" id="login">
    <div class="heading">
       <h3>Informe Clientes</h3>
    </div>

    <?php


echo '<br><br><center><h1>Puede ver la información de el cliente, si desea puede descargar el informe en ecxel
    ...
    echo '<center><tr><th>DOCUMENTO</th><th>TIPODOC</th><th>PERFIL</th><th>NOMBRE</th><th>APELLIDO</th><th>Eliminar</th></tr></center>';
    while ($filas= mysqli_fetch_row($resultado))
     {
        echo '<tr><td>'.$filas[0].'</td><td>'.$filas[1].'</td><td>'.$filas[2].'</td><td>'.$filas[3].'</td><td>'.$filas[4].'</td>
        <td><form action="eliminar7.php" method="post">
     ...
     echo ('<center><br><br><form action="generarxls7.php" method="post" class="login-form"><input type="submit" value="GENERAR_XLS" class="btn"> 
     </form></td></tr></center>');
