...
<section class="login" id="login">
    <div class="heading">
       <h3>Informe Servicios</h3>
    </div>

    <?php


echo '<br><br><center><h1>Puede ver la información del servicio, si desea puede descargar el informe en ecxel
    ...
    echo '<center><tr><th>ID</th><th>NOMBRE</th><th>PRECIO</th><th>DETALLESERVICIO</th><th>ELIMINAR</th></tr></center>';
    while ($filas= mysqli_fetch_row($resultado))
     {
        echo '<tr><td>'.$filas[0].'</td><td>'.$filas[1].'</td><td>'.$filas[2].'</td><td>'.$filas[3].'</td> 
        <td><form action="eliminar5.php" method="post">
     ...
     echo ('<center><br><br><form action="generarxls5.php" method="post" class="login-form"><input type="submit" value="GENERAR_XLS" class="btn"> 
     </form></td></tr></center>');
